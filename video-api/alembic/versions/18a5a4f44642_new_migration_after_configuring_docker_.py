"""New Migration after configuring docker compose

Revision ID: 18a5a4f44642
Revises: 
Create Date: 2026-09-06 13:40:05.573993
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'processing', 'completed', 'failed', name='outboxstatusenum'), nullable=False),
    ...
    op.create_index('ix_outbox_pending_available', 'outbox_messages', ['status', 'available_at'], unique=False)
