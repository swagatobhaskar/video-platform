...
class ThumbnailUploadService:
    ...
    async def upload(self, video_id: UUID, thumbnail_image: UploadFile):
        ...
        self.image_processor.validate_image(thumbnail_image)
        ...
        try:
            thumbnail_key = self.image_storage.upload(
            ...
            if thumbnail_key is not None:
                ...
                self.image_storage.delete(thumbnail_key, settings.thumbnails_bucket)
            raise


    async def update(self, video_id: UUID, thumbnail_image: UploadFile):
        ...
        try:
            ...
            if existing_thumbnail_key is not None:
                ...
                self.image_storage.delete(existing_thumbnail_key, settings.thumbnails_bucket)
            ...
            if new_thumbnail_key is not None:
                ...
                self.image_storage.delete(new_thumbnail_key, settings.thumbnails_bucket)
